package helpers.com.randrmusic.android.discovery.login.data;

public interface SignInPageDataProviders {

    String emailField = "com.rnrmusic.radio:id/editTextEmail";
