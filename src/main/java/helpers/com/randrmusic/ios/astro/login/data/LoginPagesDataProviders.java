...
public interface LoginPagesDataProviders {
    ...
    // Sign In
    String EmailSignIn = "//UIAApplication[1]/UIAWindow[1]/UIAImage[2]/UIATextField[1]";
    String PasswordSignIn = "//UIAApplication[1]/UIAWindow[1]/UIAImage[2]/UIASecureTextField[1]";
